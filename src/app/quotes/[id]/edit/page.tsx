  ...
  async function loadQuote() {
    try {
      ...
      if (quote.status === 'CONVERTED') {
        setError('Cannot edit converted quotes');
        setLoading(false);
        return;
      }
  ...
  return (
    <div className="max-w-5xl mx-auto p-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Customer & Dates - Same as New Quote */}
        ...
        {/* Line Items - Same structure as New Quote */}
        <div className="bg-white rounded-lg shadow p-6">
            ...
            {lineItems.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4 space-y-3">
                ...
                <div className="text-right text-sm font-medium text-gray-900">
                  Line Total: TZS {(item.quantity * item.unitPrice).toLocaleString('en-US', { minimumFractionDigits: 2 })}
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 border-t pt-4 space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">TZS {subtotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Tax:</span>
              <span className="font-medium">TZS {taxTotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
            </div>
            <div className="flex justify-between text-lg font-bold border-t pt-2">
              <span>Grand Total:</span>
              <span>TZS {grandTotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
            </div>
          </div>
        </div>
